...
export function LogoIcon({ size = 28, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        d="M9 10C9 8.89543 9.89543 8 11 8H21C22.1046 8 23 8.89543 23 10V22C23 23.1046 22.1046 24 21 24H11C9.89543 24 9 23.1046 9 22V10Z"
        fill="white"
        fillOpacity="0.15"
      />
      <path
        d="M13 13H19M13 16.5H19M13 20H16.5"
        stroke="white"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function InvoicesIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CustomersIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BusinessIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M8 7h1v1H8zM15 7h1v1h-1zM8 11h1v1H8zM15 11h1v1h-1zM8 15h1v1H8zM15 15h1v1h-1z" />
      <path d="M11 21v-4h2v4" />
    </svg>
  );
}

export const BuildingIcon = BusinessIcon;


export function SubscriptionIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SignOutIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function StampIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M9 11V5a2 2 0 1 1 4 0v1.5A1.5 1.5 0 0 0 14.5 8H17a2 2 0 0 1 2 2v1" />
      <path d="M5 18h14a1 1 0 0 0 1-1v-1a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1Z" />
      <path d="M7 21h10" />
    </svg>
  );
}

export function ArchiveIcon({ size = 20, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
