 ...
 * JPG، Excel، اشتراک‌گذاری در تلگرام، ارسال PDF با Gmail. File downloads are plain
...
export interface ExportMenuPanelProps {
  ...
  onTelegram: () => void;
  onGmail: () => void;
  /** Fired when a download/print link is activated (the container closes). */
  onNavigate?: () => void;
}
